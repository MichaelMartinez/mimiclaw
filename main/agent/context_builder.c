...
esp_err_t context_build_system_prompt(char *buf, size_t size)
{
    ...
    off += snprintf(buf + off, size - off,
        ...
        "- memory_write: Write or overwrite long-term memory (MEMORY.md). Use to persist important facts, user preferences, context.\n"
        "- daily_note: Append a note to today's daily memory file. Use for logging events, observations, conversation highlights.\n\n"
